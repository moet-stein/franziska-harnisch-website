...
export default function PictureHometwo({ pic }) {
    ...
    return (<Grid container style={{ width: "100%" }} >
        <Grid item xs={12} sm={4} style={{ paddingLeft: 30, display:"flex", flexDirection:"column-reverse" }}  >
            ...
            <img style={{ borderRadius: 5, width:240 }} onMouseOver={() => setExit(prev => !prev)} className={exit ? classes.imageMask : classes.imageNoMask} src={typeof pic[0].image === 'string' ? pic[0].image : pic[0].image} />
        ...
        <Grid item xs={12} sm={4} >  {/*             <PreviewCompatibleImage imageInfo={pic[2].image} style={{ borderRadius: 5 }} onMouseOver={() => setVisible(prev => !prev)} className={visible ? classes.imageMask : classes.imageNoMask} image={pic[2].image} fluid={pic[2].image.childImageSharp.fluid.src} /> */}
            <img style={{ borderRadius: 5, width:240 }} onMouseOver={() => setVisible(prev => !prev)} className={visible ? classes.imageMask : classes.imageNoMask} src={typeof pic[1].image === 'string' ? pic[1].image : pic[1].image} />
        ...
        <Grid item xs={12} sm={4}  >
            ...
            <img style={{ borderRadius: 5, width:240 }} onMouseOver={() => setThirdPic(prev => !prev)} className={thirdPic ? classes.imageMask : classes.imageNoMask} src={typeof pic[2].image === 'string' ? pic[2].image : pic[2].image} />
